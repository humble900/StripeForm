...
import {
  BrandKitProvider,
  useBrandKit,
} from "@/components/providers/BrandKitProvider";
...
export function BrandKitContent() {
  ...
  if (!brandKit || !isHydrated) {
    return (
      <div className="flex justify-center p-8">
        <InlineLoading variant="dots" size="lg" text="Loading brand kit..." />
      </div>
    );
  }
  ...
  const applyTextLogo = (updates: Partial<typeof baseTextLogo>) => {
    ...
    updateBrandKit({
      customTextLogo: { ...baseTextLogo, ...current, ...updates } as any,
    });
  };
  ...
  const addCustomColor = () => {
    ...
    updateBrandKit({
      ...
      colors: {
        ...brandKit.colors,
        custom: [...(brandKit.colors.custom || []), newColor],
      },
    });
    setNewColorName("");
  };
  ...
  const removeCustomColor = (colorId: string) => {
    ...
    const updatedCustom = brandKit.colors.custom.filter(
      (c) => c.id !== colorId,
    );
    updateBrandKit({
      ...brandKit,
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Customize your form branding and styling with advanced controls
              </p>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <TabsContent value="colors" className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <ColorPicker
                        color={
                          brandKit.colors?.pageBackground || {
                      ...
                      <ColorPicker
                        color={
                          brandKit.colors?.formBackground || {
                      ...
                      <ColorPicker
                        color={
                          brandKit.colors?.fieldBackground || {
                      ...
                      <ColorPicker
                        color={
                          brandKit.colors?.buttonSecondary || {
                      ...
                      <ColorPicker
                        color={
                          brandKit.colors?.headerBackground || {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {brandKit.colors?.custom &&
                      brandKit.colors.custom.length > 0 && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {brandKit.colors.custom.map((color) => (
                            <ColorPicker
                              ...
                              onDelete={() =>
                                color.id && removeCustomColor(color.id)
                              }
                              showDelete
                              label={color.name}
                            />
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <select
                          value={
                            brandKit.typography?.fontFamily?.primary || "Inter"
                          }
                          onChange={(e) =>
                            updateTypography(
                              "fontFamily",
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          value={
                            brandKit.typography?.fontFamily?.secondary ||
                            "Inter"
                          }
                          onChange={(e) =>
                            updateTypography(
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateTypography("fontSize", "xl", e.target.value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateTypography("fontSize", "base", e.target.value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={
                            brandKit.typography?.fontSize?.sm || "0.875rem"
                          }
                          onChange={(e) =>
                            updateTypography("fontSize", "sm", e.target.value)
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            value={
                              brandKit.formStyling?.layout?.width || "medium"
                            }
                            onChange={(e) =>
                              updateFormStyling(
                                "layout",
                        ...
                        {brandKit.formStyling?.layout?.width === "custom" && (
                          <div className="space-y-2">
                            ...
                            <Input
                              value={
                                brandKit.formStyling?.layout?.maxWidth ||
                                "768px"
                              }
                              onChange={(e) =>
                                updateFormStyling(
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.layout?.borderRadius ||
                              "0.5rem"
                            }
                            onChange={(e) =>
                              updateFormStyling(
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.spacing?.sectionGap ||
                              "2rem"
                            }
                            onChange={(e) =>
                              updateFormStyling(
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.spacing?.fieldGap ||
                              "1.5rem"
                            }
                            onChange={(e) =>
                              updateFormStyling(
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.spacing?.labelGap || "1rem"
                            }
                            onChange={(e) =>
                              updateFormStyling(
                                "spacing",
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateFormStyling("button", "primary", {
                                ...brandKit.formStyling?.button?.primary,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.button?.secondary
                                ?.padding || "0.75rem 1.5rem"
                            }
                            onChange={(e) =>
                              updateFormStyling("button", "secondary", {
                                ...brandKit.formStyling?.button?.secondary,
                                padding: e.target.value,
                              })
                            }
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.input?.padding || "0.75rem"
                            }
                            onChange={(e) =>
                              updateFormStyling(
                                "input",
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            value={
                              brandKit.formStyling?.input?.borderRadius ||
                              "0.375rem"
                            }
                            onChange={(e) =>
                              updateFormStyling(
              ...
              <TabsContent value="logos" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Brand Identity Options</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div className="text-center space-y-2">
                        <button
                          ...
                          onClick={() =>
                            applyTextLogo({
                              color:
                                brandKit.colors?.buttonSecondary?.hex ||
                                "#8b5cf6",
                            })
                          }
                          className="w-full bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow"
                      ...
                      <div className="text-center space-y-2">
                        <button
                          ...
                          onClick={() =>
                            applyTextLogo({
                              color: brandKit.colors?.focus?.hex || "#10b981",
                            })
                          }
                          className="w-full bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow"
                        >
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <LogoUpload
                      currentAsset={
                        (brandKit as any)?.logo?.main?.light || undefined
                      }
                      onUpload={(asset) => {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              applyTextLogo({ text: e.target.value })
                            }
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            value={
                              brandKit.customTextLogo?.fontFamily || "Inter"
                            }
                            onChange={(e) =>
                              applyTextLogo({ fontFamily: e.target.value })
                            }
                            className="w-full p-2 border border-gray-300 rounded-md"
                          >
                            <option value="Inter">Inter</option>
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              applyTextLogo({ fontSize: e.target.value as any })
                            }
                            className="w-full p-2 border border-gray-300 rounded-md"
                          >
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-3">
                            <input
                              type="color"
                              value={
                                brandKit.customTextLogo?.color || "#3b82f6"
                              }
                              onChange={(e) =>
                                applyTextLogo({ color: e.target.value })
                              }
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            value={
                              brandKit.customTextLogo?.fontWeight || "bold"
                            }
                            onChange={(e) =>
                              applyTextLogo({
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            value={
                              brandKit.customTextLogo?.textTransform || "none"
                            }
                            onChange={(e) =>
                              applyTextLogo({
                                ...
                                : brandKit.customTextLogo?.fontSize === "base"
                                  ...
                                  : brandKit.customTextLogo?.fontSize === "lg"
                                    ...
                                    : brandKit.customTextLogo?.fontSize === "xl"
                                      ? "1.25rem"
                                      : brandKit.customTextLogo?.fontSize ===
                                          "2xl"
                                        ? "1.5rem"
                                        : brandKit.customTextLogo?.fontSize ===
                                            "3xl"
