...
const FormPreview = () => {
  ...
  return (
    <div 
      className={`mx-auto ${getFormWidth()}`}
          ...
          {brandKit.customTextLogo?.text ? (
            ...
            brandKit.logo.current.type === 'text' ? (
              <div
                ...
                style={{
                  color: brandKit.logo.current.color || brandKit.colors?.buttonPrimary?.hex || '#3b82f6',
                  fontFamily: brandKit.logo.current.fontFamily || brandKit.typography?.fontFamily?.primary || 'Inter',
              ...
              <img
                src={typeof brandKit.logo.current.file === 'string' ? brandKit.logo.current.file : '/logo-placeholder.png'}
                alt="Brand Logo"
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            placeholder="Enter your name"
                ...
                style={{
                  ...
                  borderRadius: brandKit.formStyling?.input?.borderRadius || '0.5rem',
                  ...
                  backgroundColor: brandKit.colors?.fieldBackground?.hex || '#ffffff',
                  color: brandKit.colors?.text?.primary?.hex || '#0f172a',
                  fontFamily: brandKit.typography?.fontFamily?.primary || 'Inter'
                }}
              />
          ...
          <div className="pt-4">
            <Button 
              className="w-full"
              style={{
                padding: brandKit.formStyling?.button?.primary?.padding || '0.75rem 1.5rem',
                borderRadius: brandKit.formStyling?.button?.primary?.borderRadius || '0.5rem',
                fontSize: brandKit.typography?.fontSize?.base || '1rem',
                fontWeight: brandKit.formStyling?.button?.primary?.fontWeight || '600',
