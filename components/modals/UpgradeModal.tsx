        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="space-y-2.5 sm:space-y-3 mb-3 sm:mb-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-700">API access & webhooks</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs sm:text-sm font-medium text-gray-700">Pro Plans</span>
              <div className="text-right">
                <div className="text-base sm:text-lg font-bold text-gray-900">$5/month</div>
                <div className="text-xs sm:text-sm text-gray-600">or $60/year</div>
              </div>
            </div>
