    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300 animate-fade-in-up-delayed-1">
                          <div className="w-16 h-16 bg-[#6C5CE7] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-opacity-20 transition-all duration-300">
              <SparklesIcon className="w-8 h-8 text-[#6C5CE7] group-hover:scale-110 transition-transform duration-300" />
            </div>
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300 animate-fade-in-up-delayed-2">
                          <div className="w-16 h-16 bg-[#6C5CE7] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-opacity-20 transition-all duration-300">
              <DocumentTextIcon className="w-8 h-8 text-[#6C5CE7] group-hover:scale-110 transition-transform duration-300" />
            </div>
            ...
            {/* Drag & drop builder */}
            <div className="text-center group hover:scale-105 transition-transform duration-300 animate-fade-in-up-delayed-3">
                          <div className="w-16 h-16 bg-[#6C5CE7] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-opacity-20 transition-all duration-300">
              <ArrowsPointingOutIcon className="w-8 h-8 text-[#6C5CE7] group-hover:scale-110 transition-transform duration-300" />
            </div>
          ...
          {/* Start instantly block */}
                      <div className="bg-[#6C5CE7] bg-opacity-5 rounded-lg p-8 flex items-center justify-between hover:bg-opacity-10 transition-all duration-300 animate-fade-in-up-delayed-4">
              <div className="flex items-center">
                <div className="w-12 h-12 bg-[#6C5CE7] bg-opacity-10 rounded-full flex items-center justify-center mr-4 hover:bg-opacity-20 transition-all duration-300">
                  <ClipboardDocumentIcon className="w-6 h-6 text-[#6C5CE7] hover:scale-110 transition-transform duration-300" />
                </div>
              <div>
              ...
              href="/builder"
              prefetch={true}
              className="bg-[#6C5CE7] text-white px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 hover:scale-105 transition-all duration-300"
            >
              Create a form
            </Link>
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Form Preview */}
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up-delayed-1">
              ...
              <div className="flex justify-between">
                <button className="text-gray-500 hover:text-gray-700 transition-colors duration-300">← Back</button>
                                 <button className="bg-[#6C5CE7] text-white px-6 py-2 rounded-lg font-semibold hover:bg-opacity-90 hover:scale-105 transition-all duration-300">Next →</button>
              </div>
            </div>
            ...
            <div className="animate-fade-in-up-delayed-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start group hover:scale-105 transition-transform duration-300">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-1 group-hover:bg-green-200 transition-colors duration-300">
                    <svg className="w-4 h-4 text-green-600 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in-up-delayed-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up-delayed-2">
            <Link
              href="/builder"
              prefetch={true}
              className="bg-[#6C5CE7] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-opacity-90 hover:scale-105 transition-all duration-300 inline-flex items-center justify-center"
            >
              Create a form - it's free
            </Link>
            <Link
              href="/pricing"
              prefetch={true}
              className="bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-semibold border border-gray-300 hover:bg-gray-50 hover:scale-105 transition-all duration-300"
            >
              See pricing
            </Link>
          </div>
