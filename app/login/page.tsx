...
function LoginPageInner() {
  ...
  const handleGithubSignIn = async () => {
    ...
    try {
      console.log('🔍 Login page: Attempting GitHub sign in...')
      
      await signInWithGithub()
      
      console.log('✅ Login page: GitHub sign in successful')
      ...
      console.error('❌ Login page: GitHub sign in failed:', error)
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/forgot-password" className="font-medium bg-gradient-to-r from-blue-500 via-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-blue-600 hover:via-blue-700 hover:to-purple-700">
